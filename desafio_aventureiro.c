...
int main(){
    ...
    // Cálculo da Densidade Populacional das cidades da Carta 01 e 02
    ...
    pib_percapita1 = pib_1 / populacao1;
    pib_percapita2 = pib_2 / populacao2;

    
    // Exibição do Resultado

    printf("\n");
    printf("=== JOGO TRIUNFO - CARTA 1 ===: \n");
    printf("1. Estado: '%c'\n", letra_estado1);
    printf("2. Código: %s\n", codigo_estado1);
